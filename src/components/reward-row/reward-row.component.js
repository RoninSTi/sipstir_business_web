...
const RewardRow = ({ reward }) => {
  ...
  const isDeleting = useSelector(state => state.ui.isLoading.some(element => element.loadingType === DELETE_REWARD && element.meta === id))
  ...
  const handleDeleteReward = () => {
    dispatch({
      ...
      payload: {
        ...
        title: 'Delete reward?',
        message: 'This action will permanently delete the reward.  Ensure you have an active reward to pariticipate in our advertising progam.'
      }
    })
  }
