...
const UpdatePaymentModal = () => {
  ...
  const isLoading = useSelector(state => state.ui.isLoading.some(element => element.loadingType === UPDATE_PAYMENT_METHOD))
  ...
  const handleUpdate = async () => {
    ...
    dispatch(updatePaymentMethodAction({ accountId, customerId, paymentMethodId: paymentMethod.id, token }))
